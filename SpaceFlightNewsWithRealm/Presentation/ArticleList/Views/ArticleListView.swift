...
struct ArticleListView: View {
    ...
    var body: some View {
        ...
        .padding(.bottom)
        .onSubmit(of: .search) {
            @ObservedRealmObject var searchHistory = SearchHistoryObject(value: ["searchText":vm.searchText])
//            for article in vm.filteredArticles {
//                searchHistory.articles.append(article.convertToArticleObject())
//            }
            $searchHistories.append(SearchHistoryObject(value: ["searchText":vm.searchText]))
        }
        .task {
            do {
